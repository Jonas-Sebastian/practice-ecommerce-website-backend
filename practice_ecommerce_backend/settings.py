"""
Django settings for practice_ecommerce_backend project.
...
ALLOWED_HOSTS = [
    "127.0.0.1",
    "https://jonas-sebastian-ecommerce-backend.onrender.com",
]
...
WSGI_APPLICATION = 'practice_ecommerce_backend.wsgi.application'
